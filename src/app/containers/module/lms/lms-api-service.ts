...
export interface ILookupsClient {
    getAllLookups(): Observable<GetLookupResponse[]>;
    createLookup(command: CreateLookupCommand): Observable<number>;
    getPaginatedLookups(pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfGetLookupResponse>;
    getLookup(id: number): Observable<GetLookupResponse>;
    updateLookup(id: number, command: UpdateLookupCommand): Observable<void>;
...
export class LookupsClient implements ILookupsClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetLookupResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetLookupResponse[]>;
        }));
    }

    protected processGetAllLookups(response: HttpResponseBase): Observable<GetLookupResponse[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(GetLookupResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    getPaginatedLookups(pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfGetLookupResponse> {
        let url_ = this.baseUrl + "/api/Lookups/GetPaginatedLookups?";
        if (pageNumber === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPaginatedLookups(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPaginatedLookups(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PaginatedListOfGetLookupResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaginatedListOfGetLookupResponse>;
        }));
    }

    protected processGetPaginatedLookups(response: HttpResponseBase): Observable<PaginatedListOfGetLookupResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaginatedListOfGetLookupResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    protected processGetLookup(response: HttpResponseBase): Observable<GetLookupResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetLookupResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class GetLookupResponse implements IGetLookupResponse {
    id?: number;
    code?: string;
    name?: string;
    nameBN?: string;
    ...
    constructor(data?: IGetLookupResponse) {
        if (data) {
    ...
    static fromJS(data: any): GetLookupResponse {
        data = typeof data === 'object' ? data : {};
        let result = new GetLookupResponse();
        result.init(data);
        return result;
    }
...
export interface IGetLookupResponse {
    id?: number;
    code?: string;
    name?: string;
    nameBN?: string;
...
export class PaginatedListOfGetLookupResponse implements IPaginatedListOfGetLookupResponse {
    items?: GetLookupResponse[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    ...
    constructor(data?: IPaginatedListOfGetLookupResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items!.push(GetLookupResponse.fromJS(item));
            }
    ...
    static fromJS(data: any): PaginatedListOfGetLookupResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedListOfGetLookupResponse();
        result.init(data);
        return result;
    }
...
export interface IPaginatedListOfGetLookupResponse {
    items?: GetLookupResponse[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
